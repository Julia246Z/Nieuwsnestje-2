        ...
        <div className="text-center">
          ...
          <div className="flex justify-center mb-12">
            {!isOpened ? (
              ...
              >
                <div className="w-64 h-64 bg-gradient-to-br from-red-400 to-orange-400 rounded-3xl relative shadow-2xl">
                  <div className="absolute inset-4 bg-gradient-to-br from-red-300 to-orange-300 rounded-2xl"></div>
